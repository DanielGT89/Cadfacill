...
<b> <center>
     ...
     <h1>Formulário de Cadastro De Batismo</h1>

     <form id="formaCadastro" action="crudbatimos.php" method="POST">
        ...
        <fieldset class="bloco">
            ...
            <input type="number" id="cpf" name="cpf" placeholder="Digite o CPF" maxlength="14" required oninput="this.value = this.value.slice(0, 14)" required><br><br>
        ...
        <fieldset class="bloco">
            ...
            <input type="hidden" name="id_alterar" value="<?php echo $_SESSION['id']; ?>"> <!--- Viculado ao arquivo tabelabatismo.PHP // fazer cadastro--->

        
            <label for="arquivo">Documentos Complementares:</label>
            <input type="file" id="arquivo" name="arquivo" multiple class="botao1"><br><br>
            ...
            <tbody class="tabela">
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<td><a href='editarbatismo.php?id=" . $row['id'] . "'>Editar</a></td>"; // chamando editarbatismo.php para fazer alateraçao no cadastro
                        echo "</tr>";
                    }
                } else {
