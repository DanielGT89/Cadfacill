...
include('tabelabatismoadmin.php');
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <?php if(isset($_SESSION['admin']) && $_SESSION['admin'] === true): ?>
                            <li><a href="relatorioabatismodmin.php">Dados de Batismo</a></li>
                         <?php endif; ?>
                         <?php if(isset($_SESSION['admin']) && $_SESSION['admin'] === true): ?>
...
<center>
     <table border="1" width="1500px" class="tabela">
            <thead height="50px">
                <h2 class="facilite">Tabela Batismo</h2>
                <tr >
            ...
            <tbody class="tabela">
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<td><a href=editarbatismoadmin.php?id=" . $row['id'] . "'>Editar</a></td>"; 
                        echo "<td><a href=excluirbatismoadmin.php?id=" . $row['id'] . "'>Excluir</a></td>"; 
                        echo "</tr>";
                    }
                } else {
