...
<center>
     <table border="1" width="1500px" class="tabela">
            <thead height="50px">
                <h2 class="facilite">Tabela Membros</h2>
                <tr >
            ...
            <tbody class="tabela">
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<td><a href='editarmembroadmin.php?id=" . $row['id'] . "'>Editar</a> </td>";
                        echo "<td><a href=exluirmembroadmin.php?id=" . $row['id'] . "'>Excluir</a></td>"; 
                        echo "</tr>";
                    }
                } else {
