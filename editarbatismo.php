                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <?php if(isset($_SESSION['admin']) && $_SESSION['admin'] === true): ?>
                         ...
                         <?php endif; ?>
                         <?php if(isset($_SESSION['admin']) && $_SESSION['admin'] === true): ?>
                            <li><a href="relatoriologinadmin.php">Dados de Membros</a></li>
                         <?php endif; ?>
                         <?php if(isset($_SESSION['admin']) && $_SESSION['admin'] === true): ?>
...
<b> <center>
     ...
     <h1 class="label">Formulário de Cadastro De Batismo</h1>

     <form id="formaCadastro" action="alterarbatismo.php" method="POST">
           ...
           <tbody class="tabela">
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<td><a href='crudeditar.php?id=" . $row['id'] . "'>Editar</a></td>"; // Adicione as ações desejadas
                        echo "</tr>";
                    }
                } else {
