...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if ($stmt->execute()) {
            ...
            echo '<script>alert("Cadastro com sucesso"); location.href = "cadastrodebatismo.php";</script>';
        }
